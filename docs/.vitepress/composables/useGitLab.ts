...
export function useGitLab(projectId: string, userId?: string) {
  ...
  async function fetchMergeRequests() {
    ...
    try {
      ...
      mergeRequests.value.push(...(Array.isArray(data) ? data : []));
  ...
  async function fetchIssues() {
    ...
    try {
      ...
      if (userId) {
        ...
        issuesData.push(...(Array.isArray(assignedIssues) ? assignedIssues : []));
        ...
        issuesData.push(...(Array.isArray(uniqueAuthoredIssues) ? uniqueAuthoredIssues : []));
      ...
      issues.value.push(...(Array.isArray(issuesData) ? issuesData : []));
